...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="js/funcionesanio.js"></script>
        <!--    JQUERY    -->
        <!--    FORMATO DE TABLAS    -->
    ...
    <div class="consul">
        <div id="divimgs1" style="background-color: #000">
             <div id="logo1"><img src="../images/logo.png" width="222" height="59" /></div>     
        </div>        
