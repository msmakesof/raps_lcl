...
<html>
    <head>
        <title>.::: Consulta de Lista de Chequeo Cronogramas</title>
        <meta charset="utf-8">
        <!--    ESTILO GENERAL   -->
        ...
        <script type="text/javascript" language="javascript" src="js/funcioneslccr.js"></script>
        <!--    JQUERY    -->
        <!--    FORMATO DE TABLAS    -->
    ...
    <div class="consul">
        ...
        <header class="gradient">
          <h2>LISTA DE CHEQUEO CRONOGRAMAS</h2>
        </header>
				<div align="center" style="clear:both;padding:8px;margin-bottom:5px;height:14px;">			
					<div style="float:left;width:20%;font-family:Verdana, Geneva, sans-serif;font-size:11;color:#36C;font-weight:bold">
					 ...
					 <?php if($row_rs_privilegios['control'] =='S'){ ?>
						...
						<a href="#" onclick="TINY.box.show({iframe:'../cronos/add.php',boxid:'frameless',width:1010,height:870,fixed:false,maskid:'blackmask',maskopacity:40,closejs:function(){closeJS()}})" id="creaudita" class="fuentetest3"><img src="../imgs/lista.jpg" width="30" height="30" border="0" align="absmiddle" />  Crear Nombre</a>
						<?php } 
					}
					?>
					 </div>
					 <div style="float:left;width:20%;font-family:Verdana, Geneva, sans-serif;font-size:11;color:#36C;">
					  <?php if($row_rs_privilegios['control'] =='S'){ ?>
    <?php if($row_rs_privilegios['graba'] =='Y'){ ?>
    <a href="../formato/importar_excel/indexcronoimpo.php" id="btnneuvo" class="fuentetest3" ><img src="../imgs/lista.jpg" width="30" height="30" border="0" align="absmiddle" /> Importar Lista</a>
    <?php } 
	}
	?></div>
					 <div style="float:left;width:20%;font-family:Verdana, Geneva, sans-serif;font-size:11;color:#36C;">
				 <?php if($row_rs_privilegios['control'] =='S'){ ?>
    <?php if($row_rs_privilegios['graba'] =='Y'){ ?>
    <a href="#" onclick="TINY.box.show({iframe:'../cronos/asignar.php',boxid:'frameless',width:1010,height:600,fixed:false,maskid:'blackmask',maskopacity:40,closejs:function(){closeJS()}})" id="creaudita" class="fuentetest3"><img src="../imgs/lista.jpg" width="30" height="30" border="0" align="absmiddle" /> Lista de Chequeo Manual</a>
    <?php } 
	}
	?>
					 </div>
