...
if($_REQUEST) {
	...
	$query_Recordset1 = "SELECT nom_tabla FROM tablas WHERE nom_tabla ='".$usr."'";
	...
	if($totalRows_Recordset1 > 0){
		...
		echo '});';
		echo '</script>';			
		echo '<div id="Errorx">Nombre de Tabla No Disponible, digite un Nombre de Tabla diferente.<img src="../../no_ok.jpeg" width="32" height="32"></div>';
	}
	else{
		echo '<script language="javascript">';
		echo '$(document).ready(function() {';
