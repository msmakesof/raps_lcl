...
$cn=  Conectarse();
$listado=  mysql_query("SELECT * FROM sexo ORDER BY nom_sexo",$cn);
?>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    ...
    <tfoot>
      ...
      <tbody>
       ...
       {
			$codigo = mb_convert_encoding($reg['cod_sexo'], "UTF-8");
			echo '<tr>';
			echo '<td>';
			echo "<a href='javascript:void(0)' id='c' title='$codigo'>".$codigo."</a></td>";
			echo '<td>'.mb_convert_encoding($reg['nom_sexo'], "UTF-8").'</td>';
			echo '</tr>';	 
		}
        ?>
    <tbody>
