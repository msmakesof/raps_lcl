...
$cn=  Conectarse();
$listado=  mysql_query("SELECT * FROM tipotrafico ORDER BY nom_trafico",$cn);
?>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    ...
    <tfoot>
      ...
      <tbody>
       ...
       {
			$codigo = mb_convert_encoding($reg['cod_trafico'], "UTF-8");
			echo '<tr>';
			echo '<td>';
			echo "<a href='javascript:void(0)' id='c' title='$codigo'>".$codigo."</a></td>";
			echo '<td>'.mb_convert_encoding($reg['nom_trafico'], "UTF-8").'</td>';
			echo '</tr>';	 
		}
        ?>
    <tbody>
    ...
    <table width="250" border="0">
     ...
     $(document).ready(function(){
         $('#a1').tooltip ('Crear registros a la tabla Tipo Trafico.</p>', { width: 200, style: 'alert' });
         $('#a2').tooltip ('Borrar registros de la tabla Tipo Trafico.', { mode: 'tr', width: 200 });
		 $('#a3').tooltip ('Salir de la opci&oacute;n de Tipo Trafico.', { mode: 'tr', width: 200 });
