...
$listado=  mysql_query("SELECT * FROM anio ORDER BY year DESC; ",$cn);
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    ...
    <tfoot>
      ...
      <a href="#" onclick="TINY.box.show({iframe:'../usuarios/updyy.php?id=<?php echo $codyy; ?>',boxid:'frameless',width:990,height:550,fixed:false,maskid:'blackmask',maskopacity:40,closejs:function(){closeJS()}})"  class="fuentetest3"><?php echo $codyy; ?></a>
				<?php //}
			//}
			echo '</td>';
			?>
            ...
            <td>
						 <?php //if($row_rs_privilegios['control'] =='S'){ ?>
								<?php //if($row_rs_privilegios['graba'] =='Y'){ ?>										
										<a href="#" class="button white" id="a1" onclick="TINY.box.show({iframe:'../usuarios/addyy.php',boxid:'frameless',width:980,height:660,fixed:false,maskid:'blackmask',maskopacity:40,closejs:function(){closeJS()}})">Adicionar</a>
								 <?php //} 
								//}								
								?>
						</td>
<!--            <td><a href="del_ciu" class="button white" id="a2">Borrar</a></td>-->
     ...
     $(document).ready(function(){
         $('#a1').tooltip ('Crear registros a la tabla Años.</p>', { width: 200, style: 'alert' });
         $('#a2').tooltip ('Borrar registros de la tabla Añios.', { mode: 'tr', width: 200 });
		     $('#a3').tooltip ('Salir de la opci&oacute;n de Años.', { mode: 'tr', width: 200 });
