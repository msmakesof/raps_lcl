...
$cn=  Conectarse();
$listado=  mysql_query("SELECT * FROM incoterm ORDER BY nombre",$cn);
?>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    ...
    <tfoot>
      ...
      <tbody>
       ...
       while($reg=  mysql_fetch_array($listado))
       {
			...
			echo '<td>'.mb_convert_encoding($reg['transporte'], "UTF-8").'</td>';
			echo '</tr>';	 
		}
        ?>
    <tbody>
    ...
    <table width="250" border="0">
     ...
     $(document).ready(function(){
         $('#a1').tooltip ('Crear registros a la tabla Incoterms.</p>', { width: 200, style: 'alert' });
         $('#a2').tooltip ('Borrar registros de la tabla Incoterms.', { mode: 'tr', width: 200 });
		 $('#a3').tooltip ('Salir de la opci&oacute;n de Incoterms.', { mode: 'tr', width: 200 });
