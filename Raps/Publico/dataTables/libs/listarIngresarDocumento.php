...
$cn=  Conectarse();
$listado=  mysql_query("SELECT ingresoDocumento.*, departamento.detalle as ndetalle FROM ingresoDocumento,departamento WHERE ingresoDocumento.departamento_id = departamento.id",$cn);
echo mysql_error();
?>
<script type="text/javascript" language="javascript" src="js/jslistadopaises.js"></script>
<link rel="stylesheet" type="text/css" href="../css/style.css"/>
<title>.:::       OPC:   Gestion de Ingreso DOcumento.   :::</title><table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    <thead>
        <tr>
            <th>CODIGO</th>
            <th>DETALLE</th>            
    ...
    <tfoot>
      ...
      <tbody>
       ...
       while($reg=  mysql_fetch_assoc($listado))
       {
			...
			echo "<a href='class/mod_ingresoDocumento_cl.php?codid=$id' id='c' title='$idusu'>".$idusu."</a></td>";			
			echo '<td>'.mb_convert_encoding($reg['detalle'], "UTF-8").' '.mb_convert_encoding($reg['detalle'], "UTF-8").'</td>';			
    ...
    <table width="250" border="0">
          <tr>
            <td><a href="class/add_ingresoDocumento_cl.php" id="a1"><img src="../menu/images/report_add.png" width="32" height="32" border="0" /></a></td>
     ...
     $(document).ready(function(){
         $('#a1').tooltip ('Crear registros a la tabla Ingreo Documento.</p>', { width: 200, style: 'alert' });
         $('#a2').tooltip ('Borrar registros de la tabla Ingreo Documento.', { mode: 'tr', width: 200 });
		 $('#a3').tooltip ('Salir de la opci&oacute;n de Ingreo Documento.', { mode: 'tr', width: 200 });
