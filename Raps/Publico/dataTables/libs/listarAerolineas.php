...
$cn=  Conectarse();
$listado=  mysql_query("SELECT * FROM aerolineas ORDER BY nom_aerolinea",$cn);
?>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
    ...
    <tfoot>
      ...
      <tbody>
       ...
       {
			$codaerol = mb_convert_encoding($reg['cod_aerolinea'], "UTF-8");
			echo '<tr>';
			echo '<td>';
			echo "<a href='javascript:void(0)' id='c' title='$codaerol'>".$codaerol."</a></td>";
    ...
    <table width="250" border="0">
     ...
     $(document).ready(function(){
         $('#a1').tooltip ('Crear registros a la tabla Aerolineas.</p>', { width: 200, style: 'alert' });
         $('#a2').tooltip ('Borrar registros de la tabla Aerolineas.', { mode: 'tr', width: 200 });
		 $('#a3').tooltip ('Salir de la opci&oacute;n de Aerolineas.', { mode: 'tr', width: 200 });
