...
<body style='background-image: url("<?php echo urlInicialImagenes();?>/prospero_fondo.png");'> 
	...
	<div class="container" 	>
		<div id='titulo_forma'>
			...
			<div id='txtBusqueda' class="input-group input-group-sm"><input type="text" class="form-control" autofocus="autofocus" placeholder="Buscar" name="search" id="searchID" onkeyup='filtrarBusqueda()'><span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span></div>			
		</div>	
		<div id='forma'>
